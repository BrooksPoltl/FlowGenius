...
declare global {
  interface Window {
    electronAPI: {
      ...
      updateCategory: (categoryId: number, name: string) => Promise<IPCResponse<void>>;
      deleteCategory: (categoryId: number) => Promise<IPCResponse<void>>;
      getInterestsForCategory: (categoryId: number) => Promise<IPCResponse<string[]>>;
      setInterestsForCategory: (categoryId: number, interestNames: string[]) => Promise<IPCResponse<void>>;
      getCategorySchedule: (categoryId: number) => Promise<IPCResponse<CategorySchedule | null>>;
      setCategorySchedule: (
        categoryId: number, 
      ...
      // Dashboard analytics
      getDashboardData: () => Promise<IPCResponse<{
      ...
      getBriefingArticles: (briefingId: number) => Promise<IPCResponse<Article[]>>;

      // Article interactions
      getArticleInteractions: (articleUrls: string[]) => Promise<IPCResponse<Record<string, {
        liked: boolean;
        disliked: boolean;
        clicked: boolean;
      }>>>;
      ...
      // Summary operations
      getSummary: (briefingId: number) => Promise<IPCResponse<{
        title: string;
        subtitle: string;
        keyStories: Array<{
          title: string;
      ...
      getSummaryStats: () => Promise<IPCResponse<{
      ...
      getCooldownStatus: () => Promise<IPCResponse<{
      ...
      updateSettings: (settings: Partial<UserSettings>) => Promise<IPCResponse<void>>;
      getSetting: (key: keyof UserSettings) => Promise<IPCResponse<string | boolean>>;
      setSetting: (key: keyof UserSettings, value: string | boolean) => Promise<IPCResponse<void>>;
